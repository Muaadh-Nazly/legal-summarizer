...
Single codebase for the **full pipeline**: PDF to summarized PDF (extract, clean, translate, meta/sentence/clause split, clauses→JSON, predict labels, build graph, rank, abstract, merge). Run by **Gradio UI** in the main notebook or by calling stages in code.
